...
// Source: github.com/dgoeke/golang-rpc-demo/proto (interfaces: GreeterClient)

package mock_proto

import (
	proto "github.com/dgoeke/golang-rpc-demo/proto"
...
func (_m *MockGreeterClient) SayHello(_param0 context.Context, _param1 *proto.HelloRequest, _param2 ...grpc.CallOption) (*proto.HelloReply, error) {
